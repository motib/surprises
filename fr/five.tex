...
\begin{example}
Les faces du graphe planaire de la figure~\ref{f.five-planar-graph-graph} sont triangulaires car chacune d'elles est délimitée par trois arêtes. Les arêtes sont courbées et les faces ne sont donc pas des triangles, qui sont des polygones dont les trois côtés sont des segments.
\end{example}
...
\begin{definition}
Soit $G$ un graphe planaire colorié. Une \emph{chaîne} (de Kempe) $G'$ est un sous-graphe maximal, colorié avec deux couleurs et connexe de $G$.
\end{definition}
