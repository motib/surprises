...
\begin{proof}
Soit $H$ un point quelconque sur $c(Q,b)$. Construisons $H'$ sa réflexion autour de $\overline{PQ}$. Soit $h$ la longueur de $\overline{HH'}$  (fig.~\ref{f.compass-isoceles-trap1}).
...
Construisons les cercles $c(H,b)$ et $c(Q,h)$. Soit $K$ un point d'intersection des cercles. Construisons $K'$ la réflexion de $K$ par rapport à $\overline{PQ}$ (fig.~\ref{f.compass-isoceles-trap2}).
...
$c(K,d)$ et $c(K',d)$ (fig.~\ref{f.compass-two-circles}). $\triangle QSK'$ est un triangle rectangle, donc on a d'après le théorème de Pythagore $\overline{QS}^2 = d^2-h^2=x^2$ and $\overline{QS}=x$.
...
\begin{proof}
Soit $C'$ et $D'$ les réflexions de $C$ et $D$ autour de $\overline{AB}$.
...
\begin{proof}
Construisons $M'$, la réflexion de $M$ par rapport à $l$ et construisons le cercle $k'=c(M',r)$. Puisque $MYM'\cong\triangle MXM'$, les points $X$ et $Y$   d'intersection de $k$ et $k'$ sont les points d'intersection de $l$ et de $k$  (fig.~\ref{f.compass-circle4}).
\begin{figure}[htbp]
