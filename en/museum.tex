...
Furthermore, if the guard is placed near the top wall spanning the entire museum, she can observe all the horizontal walls (blue arrows in Fig.~\ref{f.museum.shaded}). Thus $15/3=5$ guards are sufficient to observe all the walls of the museum. Since the shaded triangles do not overlap, a guard in one shaded triangle will not be able to observe all the walls of another shaded triangle (green arrow), so $5$ guards are necessary.
