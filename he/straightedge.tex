...
\selectlanguage{hebrew}
\caption{$X$, $Y$
הן נקודות החיתוך של שני מעגלים}
...
\section{בניית ישר מקביל לישר נתון}\label{s.parallel}
...
על 
$l$
ולפי הבנייה עבור קטע מכוון, נבנה ישר מקביל ל-%
$\overline{UV}$
דרך 
$A$.
החותך את המעגל ב-%
...
\end{tikzpicture}
\selectlanguage{hebrew}
\caption{בניית קטע מכוון}\label{f.se-parallel-other1}
\end{subfigure}
\hspace{2em}
\begin{subfigure}{.45\textwidth}
\centering
...
\end{tikzpicture}
\selectlanguage{hebrew}
\caption{בניית ישר מקביל לקטע מכוון}\label{f.se-parallel-other2}
\end{subfigure}
\end{center}
\end{figure}
נבנה 
...
\section{העתקת קטע  בכיוון נתון}\label{s.direction}

\begin{theorem}\label{thm.angle}
נתון קטע, ניתן לבנות עותק שלו בכיוון של ישר אחר.
\end{theorem}
המשמעות של "כיוון" היא שישר המוגדר על ידי שתי נקודות
$A',H'$
נמצא בזווית
$\theta$
...
\end{center}
\selectlanguage{hebrew}
\caption{שימוש במעגל הקבוע להעתקת קטע}\label{f.se-copy3}
\end{figure}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{בניית קטע כיחס קטעים}\label{s.relative-straight}
...
נבחר נקודות 
$A,B,C$
שאינן על אותו ישר ונבנה קרניים
...
\section{בניית נקודות חיתוך של ישר ומעגל}\label{s.line-circle-straight}
...
\end{tikzpicture}
\end{center}
\caption{בניית נקודות החיתוך של ישר ומעגל (1)}\label{f.se-line-circle1}
\end{figure}
\begin{proof}
לפי משפט~%
\ref{thm.perpendicular}
...
כאשר 
$X,Y$
הן נקודות החיתוך של הישר והמעגל
(איור%
...
\end{tikzpicture}
\end{center}
\caption{בניית נקודות החיתוך של ישר ומעגל (2)}\label{f.se-line-circle2}
\end{figure}
לפי משפט פיתגורס
$s^2=r^2-t^2=(r+t)(r-t)$.
לפי משפט~%
...
מנקודה
$M$
בשני הכיוונים. הקצה השני של כל אחד מהקטעים האלה הוא נקודת חיתוך של 
$l$
עם המעגל.
\end{proof}
