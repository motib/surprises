...
\end{scope}
\end{tikzpicture}
\caption{Three-color the two smaller polygons}\label{f.museum.three-3}
\end{subfigure}
\hspace{3em}
\begin{subfigure}{.4\textwidth}
\begin{tikzpicture}[scale=.6]
...
\end{scope}
\end{tikzpicture}
\caption{Exchange the colors of one polygon to match the other}\label{f.museum.three-4}
\end{subfigure}
\end{center}
\end{figure}
