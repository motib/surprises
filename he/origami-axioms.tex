...
הקיפול הוא המקום הגיאומטרי של כל הנקודות שנמצאות במרחק שווה מ-%
$p_1$
ומ-%
$p_2$.
\begin{figure}[tb]
...
הקיפול הוא המקום הגיאומטרי של הנקודות הנמצאות במרחק שווה מ-%
$l_1$
ומ-%
$l_2$,
כאשר המרחק מנקודה לישר הוא אורך האנך מהנקודה לישר. קל להראות באמצעות משולשים חופפים שהקיפול הוא חוצה הזווית הנוצרת על ידי
$l_1$
ו-%
$l_2$.
...
ייתכן שקיים קיפול אחד או שנים וייתכן שאין בכלל קיפול מתאים.
...
ל-%
$l_f$.
המקום הגיאומטרי של הנקודות הנמצאות במרחק שווה מנקודה
$p_i$
ומישר
$l_i$
הוא פרבולה עם מוקד 
...
\L{(directrix)}
$l_i$.
קיפול הוא כל ישר המשיק לפרבולה (סעיף~%
\ref{s.parabola}).
...
הנוסחה של פרבולה שרירותית מסובכת מאוד, ולכן נביא כאן רק את הנוסחאות עבור פרבולות שציר הסמטרייה שלהן הוא ציר ה-%
$x$
או ציר ה-%
$y$.
\begin{figure}[tb]
...
\subsection{פיתוח משוואת הקיפול}
...
\begin{center}
\begin{tikzpicture}[scale=.8]
\draw[->,thick] (-6,0) -- node[very near start,left,xshift=-32pt] {$x$%
\R{ציר ה-}}
(6,0);
\draw[->,thick] (0,-3.2) -- node[very near start,below,yshift=-20pt] {$y$%
\R{ציר ה-}}
(0,4.5);
...
\end{tikzpicture}
\end{center}
\caption{המשיק כמקום גיאומטרי}\label{f.para:locus}
\end{figure}
...
\end{tikzpicture}
\end{center}
\caption{ההוכחה שהקיפול הוא משיק}\label{f.tangent-proof}
\end{figure}
תהי
$r$
נקודת החיתוך של האנך ל-%
$d$
דרך 
$p'$
והקיפול
...
אבל
$c$
הוא יתר במשולש ישר-זווית
$\triangle qp''p'$
ולא ייתכן שהיתר שווה לצלע אחרח במשולש. לכן לקיפול
$l$
נקודת חיתוך אחת עם הפרבולה והוא משיק לפרבולה.
\end{proof}
...
הקיפול הוא המקום הגיאומטרי של כל הנקודות על הישר המאונך ל-%
$l_2$
ובמרחק שווה מ-%
$p_1$
ו-%
