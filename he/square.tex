...
\end{tikzpicture}
\selectlanguage{hebrew}
\caption{הוכחת הבניה של Kochansky}\label{f.kochansky-proof}
\end{center}
\end{figure}
...
\end{center}
\selectlanguage{hebrew}
\caption{הבניה של \L{Ramanujan}}\label{f.ramanujan1}
\end{figure}
...
\end{tikzpicture}
\end{center}
\caption{הבניה השנייה של \L{Ramanujan}}\label{f.ramanujan2}
\end{figure}
...
\end{tikzpicture}
\end{center}
\caption{הבניה עם האורכים של סימון של ארכי קטעי הקו}\label{f.ramanujan2a}
\end{figure}
