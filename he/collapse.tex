...
\end{tikzpicture}
\selectlanguage{hebrew}
\caption{חוצה אנכי עם מחוגה קבועי}\label{f.collapse-perp-bisector-fixed}
\end{subfigure}
\hfill
\begin{subfigure}{.4\textwidth}
\centering
...
\end{tikzpicture}
\selectlanguage{hebrew}
\caption{חוצה אנכי עם מוחגה מתמוטטת}\label{f.collapse-perp-bisector-collapse}
\end{subfigure}
\end{center}
\end{figure}
...
\end{tikzpicture}
\selectlanguage{hebrew}
\caption{משולש שווה-שוקיים עם מחוגה קבועה}\label{f.collapse-equilateral-fixed}
\end{subfigure}
\hspace{3em}
\begin{subfigure}{.4\textwidth}
\centering
...
\end{tikzpicture}
\selectlanguage{hebrew}
\caption{משולש שווה-צלעות עם מחוגה מתמוטטת}\label{f.collapse-equilateral-collapse}
\end{subfigure}
\end{center}
\end{figure}
