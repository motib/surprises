...
\end{tikzpicture}
\caption{Construction of a perpendicular bisector with a fixed compass}\label{f.collapse-perp-bisector-fixed}
\end{subfigure}
\hfill
\begin{subfigure}{.4\textwidth}
\begin{tikzpicture}[scale=0.5]
...
\draw ($ (b) ! 1.2 ! (t)$) -- ($ (t) ! 1.2 ! (b)$);
\end{tikzpicture}
\caption{Construction of a perpendicular bisector with a fixed or a collapsing compass}\label{f.collapse-perp-bisector-collapse}
\end{subfigure}
\end{center}
\end{figure}
...
\draw (B) -- (t);
\end{tikzpicture}
\caption{Construction of an isoceles triangle with a fixed compass}\label{f.collapse-equilateral-fixed}
\end{subfigure}
\hspace{3em}
\begin{subfigure}{.4\textwidth}
\begin{tikzpicture}[scale=0.5]
...
\draw (B) -- (t);
\end{tikzpicture}
\caption{Construction of an equilateral triangle with a collapsing compass}\label{f.collapse-equilateral-collapse}
\end{subfigure}
\end{center}
\end{figure}
...
\vertex{D};
\end{tikzpicture}
\caption{Copy the line segment $\overline{AB}$. The orientation of $\overline{CC'}$ is not important.}\label{f.collapse-copying-1}
\end{subfigure}
\hspace{3ex}
\begin{subfigure}{.4\textwidth}
\begin{tikzpicture}[scale=0.5]
...
\draw (C) -- (D);
\end{tikzpicture}
\caption{Copying a line segment with a collapsing compass}\label{f.collapse-copying-2}
\end{subfigure}
\end{center}
\end{figure}
