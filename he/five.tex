...
\end{tikzpicture}
\caption{Five-coloring of a planar map}\label{f.five-planar-map-five}
\end{subfigure}
\hspace{3em}
\begin{subfigure}{.4\textwidth}
\begin{tikzpicture}[scale=.667]
...
\draw[fill=blue!80] (180:1) --
      ...
      (270:1) arc[start angle=270, end angle=180,  radius=1];
\end{tikzpicture}
\caption{Four-coloring of a planar map}\label{f.five-planar-map-four}
\end{subfigure}
\end{center}
\end{figure}
...
\end{tikzpicture}
\caption{The planar graph that corresponds to the planar map}\label{f.five-planar-graph-graph}
\end{subfigure}
\end{center}
\end{figure}
