...
$F$.
בגלל ש-%
$\overline{OC}=1$, $\overline{CF}=\sin (\theta/2)$
ו-%
...
ותהי
$C$
נקודת החיתוך שלו עם המעגל עם רדיוס
$1/3$.
נבנה את המיתר
$\overline{CD}$
והמיתרים
$\overline{AE}=\overline{ET}=\overline{CD}$.
בגלל שמיתרים שווים נכלאים על ידי זוויות מרכזיות שוות,
...
עם רדיוס
$1$.
ניתן לבנות את המעגל על ידי קביעת המרחק שבין רגלי החוגה למרחק שבין הסימנים על הניאוסיס. בנו קרן כהמשכו של 
$\overline{EB}$
...
ציירו את הקו 
$\overline{BC}$
וסמנו את הזוויות וקטעי הקו לפי איור%
...
\section{מספרים בני-מניה}\label{s.trisect-constructible}
...
הוכחה שניתן לבנות את המספרים המתקבלים מחמשת הפעולות:
