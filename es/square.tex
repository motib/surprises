...
\end{tikzpicture}
\end{center}
\caption{Primera construcción de Ramanujan con segmentos de recta rotulados}\label{f.square-rama1b}
\end{figure}
...
En la Fig.~\ref{f.square-ramanujan-2b} los segmentos de línea están rotulados con sus longitudes.
\end{proof}
...
\end{tikzpicture}
\end{center}
\caption{Segunda construcción de Ramanujan con segmentos de recta rotulados}\label{f.square-ramanujan-2b}
\end{figure}
