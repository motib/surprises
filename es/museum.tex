...
\end{scope}
\end{tikzpicture}
\caption{Dividir el polígono}\label{f.museum.three-2}
\end{center}
\end{minipage}
\end{figure}
...
\end{scope}
\end{tikzpicture}
\caption{Tricolor de los dos polígonos más pequeños}\label{f.museum.three-3}
\end{center}
\end{minipage}
\hfill
\begin{minipage}{.45\textwidth}
...
\end{scope}
\end{tikzpicture}
\caption{Cambia los colores de un polígono para que coincidan con los del otro}\label{f.museum.three-4}
\end{center}
\end{minipage}
\end{figure}
...
Ahora podemos demostrar el Teorema~ref{thm.tri}.
