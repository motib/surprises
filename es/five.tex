...
En 1879 Alfred B. Kempe{index{Kempe, Alfred B.} publicó una prueba del teorema de los cuatro colores, pero en 1890 Percy J. Heawood{index{Heawood, Percy J.} demostró que la prueba es incorrecta. En la sección~\ref{s.kempe} presentamos la prueba errónea de Kempe y la demostración de Heawood de que no es correcta.
...
\end{tikzpicture}
\caption{Cinco colores de un mapa plano}\label{f.five-planar-map-five}
\end{center}
\end{minipage}
\hfill
\begin{minipage}{.45\textwidth}
...
\draw[fill=blue!80] (180:1) --
      ...
      (270:1) arc[start angle=270, end angle=180,  radius=1];
\end{tikzpicture}
\caption{Cuatricromía de un mapa plano}\label{f.five-planar-map-four}
\end{center}
\end{minipage}
\end{figure}
...
\end{tikzpicture}
\caption{Asociar los vértices a las regiones de un mapa plano}\label{f.five-planar-graph-map}
\end{center}
\end{minipage}
\hfill
\begin{minipage}{.45\textwidth}
...
\end{tikzpicture}
\caption{$K_5$ no es plana}\label{f.five-k5}
\end{center}
\end{minipage}
\hfill
...
\end{tikzpicture}
\caption{Para colorear los vecinos de $v$ bastan cinco colores}\label{f.five-six-five}
\end{center}
\end{minipage}
\hfill
\begin{minipage}{.45\textwidth}
...
\draw (B) .. controls (-5,1) .. (D);
\end{tikzpicture}
\caption{Colorea $v$ con el sexto color}\label{f.five-six-six}
\end{center}
\end{minipage}
\end{figure}
...
Cualquier grafo plano $G$ puede ser de cinco colores.
\end{theorem}\index{Five-color theorem}

\begin{proof}
Por inducción sobre el número de vértices. Si $G$ cinco vértices o menos, cinco colores son suficientes.
Para el paso inductivo, por Thm.~\ref{thm.degree5} $G$ tiene un vértice $v$ con grado $5$ o menos. Eliminar $v$ para obtener $G'$. Por la hipótesis de inducción, $G'$ puede ser de cinco colores. En $G$, si el grado de $v$ es menor que $5$, o si $v_1,\ldots,v_5$, los vecinos de $v$, están coloreados con cuatro colores o menos, $v$ se puede colorear con el quinto color.
