...
\leftcaption{Berechnung des Flächeninhalts eines Dreiecks aus der Basis und der Höhe}\label{f.area-base-height-1}
\rightcaption{Berechnung des Flächeninhalts eines Dreiecks aus der Basis und der Höhe}\label{f.area-base-height-2}
\end{figure}
...
\leftcaption{Ein Viereck, das von einem Kreis umschrieben wird}\label{f.trap-1}
\rightcaption{Der vierte Scheitelpunkt muss auf dem Kreisumfang liegen}\label{f.trap-2}
\end{figure}
