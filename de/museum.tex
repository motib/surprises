...
\leftcaption{Eine beliebige Diagonale in einem Polygon}\label{f.museum.three-1}
\rightcaption{Teilen Sie das Polygon}\label{f.museum.three-2}
\end{figure}
...
\leftcaption{Dreifarbige Darstellung der beiden kleineren Polygone}\label{f.museum.three-3}
\rightcaption{Tauschen Sie die Farben eines Polygons aus, um sie an das andere anzupassen.}\label{f.museum.three-4}
\end{figure}
...
\leftcaption{Triangulation, bei der eine Diagonale im Polygon enthalten ist}\label{f.contained}
\rightcaption{Triangulation, bei der eine Diagonale nicht im Polygon enthalten ist}\label{f.museum.concave-vertices}
\end{figure}
