...
\leftcaption{Fünffarbigkeit einer planaren Karte}\label{f.five-planar-map-five}
\rightcaption{Vierfarbigkeit einer planaren Karte}\label{f.five-planar-map-four}
\end{figure}
...
\rightcaption{Der planare Graph, der der planaren Karte entspricht}\label{f.five-planar-graph-graph}
\end{figure}
...
\leftcaption{Das Entfernen einer Kante unterbricht die Verbindung des Graphen}\label{f.five-disconnected-removing}
\rightcaption{Verschmelzen von zwei Eckpunkten}\label{f.five-disconnected-merge}
\end{figure}
...
\leftcaption{Durch das Entfernen einer Kante wird die Verbindung zum Diagramm nicht unterbrochen}\label{f.five-connected-remains}
\rightcaption{Der Graph bleibt zusammenhängend und hat weniger Kanten}\label{f.five-connected-fewer}
\end{figure}
...
\leftcaption{Weniger Kanten als die Obergrenze}\label{f.five-fewer}
\rightcaption{In einem triangulierten Graphen ist die Anzahl der Kanten maximal}\label{f.five-upper-limit}
\end{figure}
...
\leftcaption{$K_5$ nicht planar ist}\label{f.five-k5}
\rightcaption{Ein gescheiterter Versuch, $K_5$ als planar zu zeichnen}\label{f.five-k5-failed}
\end{figure}
...
\leftcaption{$K_{3,3}$ nicht planar ist}\label{f.five-k33}
\rightcaption{Ein gescheiterter Versuch, $K_{3,3}$ als planar zu zeichnen}\label{f.five-k33-failed}
\end{figure}
...
\leftcaption{Fünf Farben reichen aus, um die Nachbarn von $v$}\label{f.five-six-five}
\rightcaption{Färbe $v$ mit der sechsten Farbe}\label{f.five-six-six}
\end{figure}
...
\leftcaption{Blaugrüne und blau-gelbe Kempe-Ketten}\label{f.five-kempe1}
\rightcaption{Tauschen Sie die Farben der beiden Kempe-Ketten}\label{f.five-kempe1-exchange}
\end{figure}
...
\leftcaption{Rot-gelbe und rot-grüne Ketten teilen sich rote Scheitelpunkte}\label{f.five-kempe2}
\rightcaption{Durch den Austausch der Farben werden die blauen Eckpunkte miteinander verbunden}\label{f.five-kempe2-share}
\end{figure}
