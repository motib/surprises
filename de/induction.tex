...
\begin{advanced}
Die mathematische Induktion ist eine Schlussregel, die zu den \emph{Peano-Axiomen}\index{Peano-Axiomen} zur Formalisierung der natürlichen Zahlen gehört. Das \emph{Wohlordnungsaxiom} kann verwendet werden, um das Induktionsaxiom zu beweisen, und umgekehrt kann das Induktionsaxiom verwendet werden, um das Wohlordnungsaxiom zu beweisen. Das Induktionsaxiom kann jedoch nicht aus den anderen, elementareren Peano-Axiomen bewiesen werden.
\end{advanced}
...
\begin{proof}
Wir wollen zunächst die Pascalsche Regel beweisen:\index{Pascal's rule}
\[
...
\]
Jahrhundert behauptete der Mathematiker Pierre de Fermat\index{Fermat, Pierre de}, dass alle Fermat-Zahlen Primzahlen sind, aber fast hundert Jahre später zeigte Leonhard Euler\index{Euler, Leonhard}, dass:
...
Betrachten Sie die folgende rekursive Funktion, die auf den ganzen Zahlen definiert ist:\index{McCarthy's $91$-function}
\[
