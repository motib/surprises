...
\leftcaption{Konstruktion eines gleichseitigen Dreiecks mit einem Lineal und einem Zirkel}\label{f.compass-equi}
\rightcaption{Konstruktion eines gleichseitigen Dreiecks mit nur einem Zirkel}\label{f.compass-equi-only}
\end{figure}
...
\leftcaption{Konstruktion von $x=\frac{n}{m}s$, Schritt 1}\label{f.compass-relative1}
\rightcaption{Konstruktion von $x=\frac{n}{m}s$, Schritt 2}\label{f.compass-relative2}
\end{figure}
...
\leftcaption{Konstruktion von $x=\frac{n}{m}s$, Schritt 3}\label{f.compass-relative3}
