...
\leftcaption{Keine gemeinsamen Berührungspunkte}\label{f.two-para-1-zero}
\rightcaption{Eine gemeinsame Tangente}\label{f.two-para-1-one}
\end{figure}
...
\leftcaption{Zwei gemeinsame Berührungspunkte}\label{f.two-para-1-two}
\rightcaption{Drei gemeinsame Berührungspunkte}\label{f.two-para-1-three}
\end{figure}
