...
\leftcaption{Konstruktion einer Mittelsenkrechten mit einem festen Zirkel}\label{f.collapse-perp-bisector-fixed}
\rightcaption{Konstruktion einer Mittelsenkrechten mit einem festen oder einem zusammenfallenden Zirkel}\label{f.collapse-perp-bisector-collapse}
\end{figure}
...
\leftcaption{Konstruktion eines isokratischen Dreiecks mit einem festen Zirkel}\label{f.collapse-equilateral-fixed}
\rightcaption{Konstruktion eines gleichseitigen Dreiecks mit einem zusammenklappbaren Zirkel}\label{f.collapse-equilateral-collapse}
\end{figure}
...
\leftcaption{Kopieren Sie das Liniensegment $\overline{AB}$. Die Ausrichtung von $\overline{CC'}$ ist nicht wichtig.}\label{f.collapse-copying-1}
\rightcaption{Kopieren eines Liniensegments mit einem zusammenfallenden Zirkel}\label{f.collapse-copying-2}
\end{figure}
...
\leftcaption{Konstruktion von Strahlen aus $D$}\label{f.collapse-copying-3}
\rightcaption{Konstruktion eines Kreises mit Radius $\overline{AB}$}\label{f.collapse-copying-4}
\end{figure}
