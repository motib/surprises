...
Margharita P. Beloch\index{Beloch, Margherita P.} entdeckte eine bemerkenswerte Verbindung zwischen dem Falten und der Lill-Methode: Eine Anwendung der Operation, die später als Origami-Axiom~6 bekannt wurde, erzeugt eine reelle Wurzel eines kubischen Polynoms. Die Operation wird oft als \emph{Beloch-Faltung} bezeichnet.\index{Beloch-Faltung}
